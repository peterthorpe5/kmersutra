...
FINAL_OUT_DIR="${OUT_DIR:-${BUILD_ROOT}/kmersutra_plasmodium_outgroups_v4_global_candidate_k${K_LABEL}_rawontlodbalanced_v046_${RUN_STAMP}}"
...
log_info "Starting KmerSutra v0.46 raw ONT LOD-balanced exact-screening global candidate panel build"
