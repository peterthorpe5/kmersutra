...
FINAL_OUT_DIR="${OUT_DIR:-${BUILD_ROOT}/kmersutra_plasmodium_outgroups_v4_global_candidate_k${K_LABEL}_assemblyaware_v034_${RUN_STAMP}}"
...
GLOBAL_INDEX_PROGRESS_INTERVAL="${GLOBAL_INDEX_PROGRESS_INTERVAL:-100000}"
