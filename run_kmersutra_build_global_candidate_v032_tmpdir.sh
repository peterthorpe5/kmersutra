...
K_VALUES="${K_VALUES:-55 77 101 151}"
K_LABEL="$(printf '%s' "${K_VALUES}" | tr ' ' '_')"
FINAL_OUT_DIR="${OUT_DIR:-${BUILD_ROOT}/kmersutra_plasmodium_outgroups_v3_global_candidate_k${K_LABEL}_assemblyaware_v032_${RUN_STAMP}}"
