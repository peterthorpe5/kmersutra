...
FINAL_OUT_DIR="${OUT_DIR:-${BUILD_ROOT}/kmersutra_plasmodium_outgroups_v4_global_candidate_k${K_LABEL}_rawontbalanced_v040_${RUN_STAMP}}"
...
MARKER_PROFILE="${MARKER_PROFILE:-raw_ont_balanced}"
