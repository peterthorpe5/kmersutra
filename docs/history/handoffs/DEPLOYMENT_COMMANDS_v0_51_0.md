# Archived v0.51.0 overlay, GitHub and cluster commands

This file records the v0.51.0 handoff and is retained only for provenance.
Use `docs/DEPLOYMENT_COMMANDS_v0_51_1.md` for the current release.
...
export KMERSUTRA_DB_ROOT="/path/to/kmersutra_db"
export KMERSUTRA_AI_MODEL="/path/to/final_internal_calibrator_all_training.json"
